project "v2web", :version => "4.0.0", :original_filename => "v2web_4.0.0.mdj", :generated_by => "Star UML plugin: ruby-dsl-generator.js v0.0.0", :generated_at => "Mon Nov 06 2023 09:40:37 GMT-0700 (Mountain Standard Time)", :additional_info => { :selected_model => { :name => "Application", :id => "AAAAAAFF+qBWK6M3Z8Y=", :pluralize_role_names => true, :snakecase_role_names => true }}, :id => "AAAAAAFF+h6SjaM2Hec=" do
