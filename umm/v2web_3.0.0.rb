project "v2web", :version => "3.0.0", :original_filename => "v2web_3.0.0.mdj", :generated_by => "Star UML plugin: ruby-dsl-generator.js v0.0.0", :generated_at => "Fri Aug 11 2023 16:27:49 GMT-0600 (Mountain Daylight Time)", :additional_info => { :selected_model => { :name => "Application", :id => "AAAAAAFF+qBWK6M3Z8Y=", :pluralize_role_names => true, :snakecase_role_names => true }}, :id => "AAAAAAFF+h6SjaM2Hec=" do
  ...
  package "HL7", :id => "AAAAAAGJjcjsRfjoWRM=" do
    ...
    package "V2", :id => "AAAAAAGJdVwMVCdiIS8=" do
       # Association # HL7::V2::Message::trigger <-> HL7::V2::Event::trigger_for
      association :properties => ["HL7::V2::Event::trigger", "HL7::V2::Message::trigger_for"], :id => "AAAAAAGJdWFbdioEaLY="
       # Association # HL7::V2::Event::<unspecified> <-> HL7::V2::Message::response
      association :properties => ["AAAAAAGJdWGr8y1T+eI=", "HL7::V2::Event::response"], :id => "AAAAAAGJdWGr8y1SSWc="
       # Association # HL7::V2::Event::ack_to <-> HL7::V2::Message::ack
      association :properties => ["HL7::V2::Message::ack_to", "HL7::V2::Event::ack"], :id => "AAAAAAGJdWJKHDS2yI8="
      ...
      association :properties => ["AAAAAAGJdXEMjx/WIzs=", "AAAAAAGJdXEMjx/XFI0="], :id => "AAAAAAGJdXEMjx/VXXI="
       # Association # HL7::V2::Event::response_for <-> HL7::V2::Message::responses
      association :properties => ["HL7::V2::Message::response_for", "HL7::V2::Event::responses"], :id => "AAAAAAGJ3H5s5OVjQwo="
      ...
      association :properties => ["HL7::V2::SegmentSequence::segments", "AAAAAAGJdWaXllowhZw="], :id => "AAAAAAGJdWaXllouiOg="
       # Association # HL7::V2::SegmentChoice::<unspecified> <-> HL7::V2::AbstractSegment::segments
      association :properties => ["AAAAAAGJdWdb7HTo79Q=", "HL7::V2::SegmentChoice::segments"], :id => "AAAAAAGJdWdb7HTnuJw="
      ...
      klass "Event", :implements => ["HL7::V2::Origin", "HL7::V2::Referenceable"], :id => "AAAAAAGJdV8uiyiDfgw=" do
        ...
        property "response", :type => "HL7::V2::Message", :is_navigable => true, :id => "AAAAAAGJdWGr8y1UnMc="
        ...
        property "trigger", :type => "HL7::V2::Message", :is_navigable => true, :id => "AAAAAAGJdWFbdyoFjtU="
      end
      ...
      klass "Message", :implements => ["HL7::V2::Origin", "HL7::V2::Referenceable"], :id => "AAAAAAGJdV9lAiitakA=" do
        property "name", :type => "String", :id => "AAAAAAGJehGgvglNPvA="
        property "code", :type => "String", :id => "AAAAAAGJehHMTQy07tQ="
        ...
        property nil, :type => "HL7::V2::Event", :upper => Float::INFINITY, :id => "AAAAAAGJdWGr8y1T+eI="
        property "ack_to", :type => "HL7::V2::Event", :upper => Float::INFINITY, :id => "AAAAAAGJdWJKHTS3nzM="
        property "response_for", :type => "HL7::V2::Event", :upper => Float::INFINITY, :id => "AAAAAAGJ3H5s5OVklhM="
      ...
      klass "AbstractSegment", :is_abstract => true, :id => "AAAAAAGJdV/djykBmLc=" do
        ...
        property nil, :type => "HL7::V2::SegmentChoice", :aggregation => :composite, :id => "AAAAAAGJdWdb7HTo79Q="
      end
      ...
      klass "SegmentChoice", :parents => ["HL7::V2::AbstractSegment"], :id => "AAAAAAGJdWBHKSlWTQE=" do
        ...
        property "segments", :type => "HL7::V2::AbstractSegment", :lower => 1, :upper => Float::INFINITY, :is_ordered => true, :id => "AAAAAAGJdWdb7HTpQTo="
      end
