project "v2web", :version => "4.0.2", :original_filename => "v2web_4.0.2.mdj", :generated_by => "Star UML plugin: ruby-dsl-generator.js v0.0.0", :generated_at => "Mon Nov 06 2023 14:38:05 GMT-0700 (Mountain Standard Time)", :additional_info => { :selected_model => { :name => "Application", :id => "AAAAAAFF+qBWK6M3Z8Y=", :pluralize_role_names => true, :snakecase_role_names => true }}, :id => "AAAAAAFF+h6SjaM2Hec=" do
  ...
  package "HL7", :id => "AAAAAAGJjcjsRfjoWRM=" do
    ...
    package "V2", :id => "AAAAAAGJdVwMVCdiIS8=" do
      ...
      klass "AcknowledgmentChoreography", :implements => ["HL7::V2::Origin"], :id => "AAAAAAGJrSUs0Gr4YxY=" do
      ...
      klass "Field", :implements => ["HL7::V2::Origin"], :id => "AAAAAAGJdXquwAeL1iM=" do
      ...
      klass "DataType", :implements => ["HL7::V2::Referenceable", "HL7::V2::Origin"], :id => "AAAAAAGJdXsBKxkea8g=" do
      ...
      klass "Component", :implements => ["HL7::V2::BoundToVocab", "HL7::V2::Origin"], :id => "AAAAAAGJdV5WxCgo6hg=" do
